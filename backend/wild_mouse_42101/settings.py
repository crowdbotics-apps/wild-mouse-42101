"""
Django settings for wild_mouse_42101 project.
...
ROOT_URLCONF = 'wild_mouse_42101.urls'
...
WSGI_APPLICATION = 'wild_mouse_42101.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wild_mouse_42101 API",
    "DESCRIPTION": "API documentation for wild_mouse_42101 App",
    "VERSION": "v1",
}
